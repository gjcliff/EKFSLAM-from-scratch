...
/// @brief allow a 2D vector to be multiplied by a scalar
...
/// @brief allow a 2D point to be multiplied by a scalar
/// @param lhs - a 2D point
/// @param rhs - a scalar
/// @return - a 2D point
Point2D operator*(Point2D lhs, const double & rhs);


/// @brief allow a 2D vector to be added to another 2D vector
/// @param lhs - a 2D vector
...
/// @brief allow a 2D vector to be subtracted from another 2D vector
/// @param lhs - a 2D vector
/// @param rhs - a 2D vector
/// @return - a 2D vector
Vector2D & operator-=(Vector2D & lhs, Vector2D rhs);
